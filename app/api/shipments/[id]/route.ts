  ...
  try {
    ...
    return NextResponse.json({
      ...
      items: itemsResult.rows.map((row) => ({
        ...
        request_item_id: Number(row.request_item_id),
        aid_item_id: Number(row.aid_item_id),
      ...
      legs: legsResult.rows.map((leg) => ({
        ...
        from_event_location_id: Number(leg.from_event_location_id),
        from_location_name: leg.from_location_name,
        to_event_location_id: Number(leg.to_event_location_id),
